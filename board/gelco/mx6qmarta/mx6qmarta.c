...
//#endif
	...
	//gpio_direction_output(IMX_GPIO_NR(2, 24), 1);	//EIM_CS1__GPIO2_IO24  J23  EIM_CS1
	...
	gpio_direction_output(IMX_GPIO_NR(4, 25), 1);	//DISP0_DAT4__GPIO4_IO25	P20  SPARE_3_OUT_CPU
	gpio_direction_output(IMX_GPIO_NR(4, 26), 1);	//DISP0_DAT5__GPIO4_IO26	R25  SPARE_2_OUT_CPU
	...
	gpio_direction_output(IMX_GPIO_NR(4, 9), 0);	//KEY_ROW1__GPIO4_IO09  U6 ECSPI1_UC_SS0 (ECSPI1 not used)
